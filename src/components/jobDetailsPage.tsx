...
const JobDetailsPage: React.FunctionComponent<JobDetailsPage> = ({currentJob}) => {
    ...
    const discription = currentJob.description?.split(' ')
    let benefArr: Array<string> = []

    const salary = currentJob.salary?.split('-').map(item => {
            ...
            <div className="page_container flex">
                ...
                <div className="main">
                    ...
                    <div className="job__information">
                        <div className="job__information_header flex justify-between ">
                            <h2 className='info_title text-[#3A4562]'>{currentJob.title}</h2>
                        ...
                        <div className="job__information_discription">
                            <div className="discription_about text-[#3A4562]">{
                                discription?.map((item, index, arr) => {
                            ...
                            <div className="images flex gap-4">
                                {
                                    currentJob.pictures?.map((item, index) => {
                                        return <img key={index} src={item} className='object-cover w-[210px] h-[116px] bg-[#D8D8D8] rounded-lg' />
                                    })
                                }
                            </div>
                        </div>
                ...
                <div className="info-panel">
                    ...
                    <div className="info_card bg-cover bg-no-repeat bg-top bg-[#2A3047] rounded-t-lg" >
                        <h2 className="departament-name relative text-[#E7EAF0] pb-1">Departament name. {currentJob.name}</h2>
                        ...
                        <p className="text-info relative text-[#E8EBF3]">{currentJob.phone}</p>
                        <p className="text-info relative text-[#E8EBF3]">{currentJob.email}</p>
